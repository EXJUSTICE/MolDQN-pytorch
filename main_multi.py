...
from agent import MultiObjectiveRewardMolecule, Agent
import hyp
import hypmulti
import math
import utils
...
environment = MultiObjectiveRewardMolecule(
      target_molecule=hypmulti.target_molecule,
      similarity_weight=hypmulti.similarity_weight,
      discount_factor=hypmulti.discount_factor,
      atom_types=set(hypmulti.atom_types),
      init_mol=hypmulti.start_molecule,
      allow_removal=hypmulti.allow_removal,
      allow_no_modification=hypmulti.allow_no_modification,
      allow_bonds_between_rings=hypmulti.allow_bonds_between_rings,
      allowed_ring_sizes=set(hypmulti.allowed_ring_sizes),
      max_steps=hypmulti.max_steps_per_episode,
