...
from agent import LogPRewardWithSimilarityConstraintMolecule, Agent
import hyp
import hypconstr
import math
import json
...
environment = LogPRewardWithSimilarityConstraintMolecule(
      similarity_constraint=hypconstr.similarity_constraint,
      discount_factor=hypconstr.discount_factor,
      all_molecules=all_molecules,
      atom_types=set(hypconstr.atom_types),
      init_mol=None,
      allow_removal=hypconstr.allow_removal,
      allow_no_modification=hypconstr.allow_no_modification,
      allow_bonds_between_rings=hypconstr.allow_bonds_between_rings,
      allowed_ring_sizes=set(hypconstr.allowed_ring_sizes),
      max_steps=hypconstr.max_steps_per_episode)
